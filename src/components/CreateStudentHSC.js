...
const CreateStudenthsc = () => {
    ...
    useEffect(() => {
        if (role === "superadmin") {
            ...
            fetchGrades(); // already exists in your code
        }
    }, [role, schoolId]);
    ...
    const fetchSections = async (schoolId, gradeId) => {
        ...
        try {
            ...
            message.error("Failed to fetch sections for this grade and school");
        }
    };
        ...
        <div className="container" style={{ maxWidth: "1400px", margin: "0 auto", padding: "40px" }}>
            <Card title={
                <div style={{ textAlign: 'center' }}>
                    <Title level={3}>Create HSC Student ApplicationForm</Title>
                    <Progress
